...
Monmouth is an agent-aware Layer 2 blockchain built on Reth v1.0.6, featuring AI/ML transaction classification, custom precompiles for AI operations, and a modular ExEx (Execution Extension) system for remote services. The project extends Reth without forking, ensuring upstream compatibility.
...
### Chain Configuration
- **Chain ID**: 42069 (defined in `primitives/src/lib.rs`)
...
- **Reth 1.0.6**: Base node implementation (pinned version)
- **Revm v14**: EVM execution with custom precompiles
